...
//                $this->dump($e);die;
    ...
    public function xero_admin_page()
    {
        ...
        if (isset($_GET['create_contact'])) {
            ...
            $this->dump(time() - $session['expires']);
            die;
            $this->_xero_create_contact("Suren111d", "Dadoyan", "suren.dadoyan97@gmail.com", "SourceCo11deee@");
        }
        if (isset($_GET['create_invoice'])) {
            $contact_response = $this->_xero_create_contact("Suren", "Dadoyan", "suren.dadoyan97@gmail.com", "SourceCode");
